namespace Gaffer.Application.Progression
{
    ...
    /// keeps the core working headless with the calibrated values. Immutable once built — defaults
    /// inline, overrides by object initializer, and <c>init</c> makes that the only way in.
    /// </summary>
    public sealed class DevelopmentSettings
    {
        ...
        public double GrowthRateTo20 { get; init; } = 0.14;

        public double GrowthRateTo22 { get; init; } = 0.10;

        public double GrowthRateTo24 { get; init; } = 0.07;

        public double GrowthRateTo26 { get; init; } = 0.045;

        public double GrowthRateTo29 { get; init; } = 0.02;
        ...
        public double MinSeasonVariance { get; init; } = 0.6;

        public double MaxSeasonVariance { get; init; } = 1.4;
