...
| 3 | Yönetim Sistemleri | 🟡 Üreteç + wonderkid + kadro→güç + attribute + rol-özel rating + gelişim + sezon-entegrasyonu ✅ · devam | **L** | |
| 4 | Karakter + Dram | ⬜ | **L** | |
